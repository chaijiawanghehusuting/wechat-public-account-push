export const config = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxbf24f2d70a346f67",

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "4cd5de24fd90ac8caee2416256fb14c4",
  ...
  USERS: [
    {
      ...
      id: "owQO854Q97P51cE-QidRIVV5NmpY",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "jAR_13kxWUmktIZdolVALWIAU8xfKI-IaHPBR6oFW9Q",
      // 所在省份
      province: "浙江",
      // 所在城市
      city: "杭州",
  ...
  CALLBACK_TEMPLATE_ID: "jAR_13kxWUmktIZdolVALWIAU8xfKI-IaHPBR6oFW9Q",
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {"type": "*生日", "name": "柴二狗", "year": "2000", "date": "03-01", isShowAge: true},
